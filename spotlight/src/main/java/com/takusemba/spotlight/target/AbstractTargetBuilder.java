 ...
 **/
public abstract class AbstractTargetBuilder<
    T extends AbstractTargetBuilder<T, S>, S extends Target> {
  ...
  protected Activity getContext() { return contextWeakReference.get(); }
  ...
  public T setOnSpotlightStartedListener(
      @NonNull final OnTargetStateChangedListener<S> listener) {
