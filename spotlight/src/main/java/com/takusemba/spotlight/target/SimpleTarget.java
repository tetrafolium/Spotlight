 ...
 * If you set your customized overlay, consider using {@link CustomTarget}
 *instead.
 **/
public class SimpleTarget extends Target {

  private SimpleTarget(final Shape shape, final PointF point,
  ...
  public static class Builder
      extends AbstractTargetBuilder<Builder, SimpleTarget> {
    ...
    public Builder(final @NonNull Activity context) { super(context); }
    ...
    public SimpleTarget build() {
      ...
      View overlay = getContext().getLayoutInflater().inflate(
          R.layout.layout_spotlight, root);
      ...
      return new SimpleTarget(shape, point, overlay, duration, animation,
                              listener);
    }
  }
}
