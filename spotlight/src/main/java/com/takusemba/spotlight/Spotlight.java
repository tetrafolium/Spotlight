...
/**
 * Spotlight that holds all the {@link Target}s and show and hide {@link Target}
 *properly, and show and hide {@link SpotlightView} properly.
 **/
public class Spotlight {
  ...
  private static final TimeInterpolator DEFAULT_ANIMATION =
  ...
  private static Context getContext() { return contextWeakReference.get(); }
   ...
   */
  @SafeVarargs
  public final <T extends Target> Spotlight setTargets(final
                                                       @NonNull T... targets) {
   ...
   * @return the Spotlight
   */
  public final <T extends Target>
      Spotlight setTargets(final @NonNull ArrayList<T> targets) {
   ...
   */
  public Spotlight
  setClosedOnTouchedOutside(final boolean isClosedOnTouchedOutside) {
   ...
   */
  public void start() { spotlightView(); }

  /**
   * close the current {@link Target}
   */
  public void closeCurrentTarget() { finishTarget(); }

  /**
   * close the {@link Spotlight}
   */
  public void closeSpotlight() { finishSpotlight(); }
  ...
  private void spotlightView() {
    ...
    SpotlightView spotlightView = new SpotlightView(
        getContext(), overlayColor, new OnSpotlightListener() {
          @Override
  ...
  private void startSpotlight() {
    if (getSpotlightView() == null)
      return;
    getSpotlightView().startSpotlight(
        duration, animation, new AbstractAnimatorListener() {
          @Override
          public void onAnimationStart(final Animator animation) {
  ...
  private void finishSpotlight() {
    if (getSpotlightView() == null)
      return;
    getSpotlightView().finishSpotlight(
        duration, animation, new AbstractAnimatorListener() {
          @Override
          public void onAnimationEnd(final Animator animation) {
